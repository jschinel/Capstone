...
import Comment from "../WordPlay_Comment"


export default function commentSection({ quote, userPermission }) {
    ...
    function handleSubmit(event) {
        ...
        postComment({ ...createFormData, contentName: quote.replace('?',''), actualContent: quote, type:'quote'})
            ...
            <div style= {{display: display}}>
                ...
                </button>
                {
                    showCreateForm && <form
                        ...
                        className="bg-gray-100 rounded-lg p-4 my-4 border-gray-700 border-2 w-[35vw] mx-auto text-right sm:w-[60dvw]">
                        <input
                            name="name"
